...
var DarkThemeToggle = function DarkThemeToggle() {
  return /*#__PURE__*/React__default.createElement("button", null, "Cambiar a modo oscuro");
};
...
export { Accordion, AccordionItem, AsideNav, AsideSection, BtnSec, Button, Card, Carrousel, Col, DarkThemeToggle, Dropdown, Graphics, Icon, InputAction, InputControl, InputField, Link, Modal, Multimedia, PanelSection, PanelTabs, RecognitionVoice, Row, Section, Select, Tab, TabPanel, Table, TableGrid, Tabs, Text, Textarea, Toggletip, Tooltip, Video };
